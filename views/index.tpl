...
<body>
    ...
    <div class="container">
        ...
        <form action='/upload' method='POST' enctype='multipart/form-data'>
            ...
            <div class="form-group row">
                <label for="plv" class="col-form-label col-xs-2">プレイヤーレベル</label>
                <div class="col-xs-1">
                    <input type='text' name='plv' class="form-control"/>
                </div>
            </div>

            <div class="form-group row">
                <label for="pno" class="col-form-label col-xs-2">ポケモンの種類 
                <select name="pno" class="form-control col-xs-2">
